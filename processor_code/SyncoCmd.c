...
/*==========================================================================*/
/*---------- Global variables---------------*/
/*  Note that sdcc is _not_ good at initializing global variables. Instead,
 *  set a default value by having main() calc do_ResetAll(). */
bit sc_mancho_enable;           // flag bit for whether manchester output is
                                // running or not
